...
let RegionPhoneMetadata_AE = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "60|8", mask: "XXX XXXXXXXXX"),
...
let RegionPhoneMetadata_AL = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "80|9", mask: "XXX XXXX"),
...
let RegionPhoneMetadata_AT = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "1(?:11|[2-9])", mask: "X XXXXXXXXX"),
		.init(leadingDigits: "517", mask: "XXX XX"),
		.init(leadingDigits: "5[079]", mask: "XX XXXXX"),
		.init(leadingDigits: "[18]", mask: "XXXXXX"),
		.init(leadingDigits: "(?:31|4)6|51|6(?:5[0-3579]|[6-9])|7(?:20|32|8)|[89]", mask: "XXX XXXXXX"),
		.init(leadingDigits: "[2-467]|5[2-6]", mask: "XXXX XXXXXXXXX"),
		.init(leadingDigits: "5", mask: "XX XXX XXX"),
		.init(leadingDigits: "5", mask: "XX XXXX XXXXXX")
	]
)
...
let RegionPhoneMetadata_BD = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "31[5-8]|[459]1", mask: "XX-XXXX"),
		...
		.init(leadingDigits: "[13-9]|22", mask: "XXXX-XXX"),
		.init(leadingDigits: "2", mask: "X-XXXXXXXX")
	]
)
...
let RegionPhoneMetadata_BG = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "[356]|4[124-7]|7[1-9]|8[1-6]|9[1-7]", mask: "XX XXX XXX"),
...
let RegionPhoneMetadata_BR = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "1(?:1[25-8]|2[357-9]|3[02-68]|4[12568]|5|6[0-8]|8[015]|9[0-47-9])|321|610", mask: "XXXXXX"),
...
let RegionPhoneMetadata_BY = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "800", mask: "XXX XX XXXX"),
...
let RegionPhoneMetadata_CL = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "60|8", mask: "XXX XXX XXXX"),
...
let RegionPhoneMetadata_CN = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "10|96", mask: "XXXXXX"),
		.init(leadingDigits: "(?:10|2[0-57-9])[19]", mask: "XX XXXXXX"),
		.init(leadingDigits: "[1-9]", mask: "XXX XXXX"),
...
let RegionPhoneMetadata_CU = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "7", mask: "X XXXXXXX"),
...
let RegionPhoneMetadata_DE = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "3[02]|40|[68]9", mask: "XX XXXXXXXXXXXXX"),
		.init(leadingDigits: "2(?:0[1-389]|1[124]|2[18]|3[14])|3(?:[35-9][15]|4[015])|906|(?:2[4-9]|4[2-9]|[579][1-9]|[68][1-8])1", mask: "XXX XXXXXXXXXXX"),
		.init(leadingDigits: "[24-6]|3(?:[3569][02-46-9]|4[2-4679]|7[2-467]|8[2-46-8])|70[2-8]|8(?:0[2-9]|[1-8])|90[7-9]|[79][1-9]", mask: "XXXX XXXXX"),
		.init(leadingDigits: "138", mask: "XXX XXXX"),
		.init(leadingDigits: "3", mask: "XXXXX XXXXXXXXXX"),
		.init(leadingDigits: "181", mask: "XXX XXXXXXX"),
		.init(leadingDigits: "1(?:3|80)|9", mask: "XXX X XXXXXXXXXX"),
		.init(leadingDigits: "1[67]", mask: "XXX XXXXXXX"),
		.init(leadingDigits: "8", mask: "XXX XXXXXXX"),
...
let RegionPhoneMetadata_EE = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "[45]|8(?:00|[1-49])", mask: "XXXX XXXX"),
...
let RegionPhoneMetadata_FI = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "[12]00|[368]|70[07-9]", mask: "XXX XXXXX"),
		.init(leadingDigits: "[1245]|7[135]", mask: "XX XXXXXXX"),
		.init(leadingDigits: "7", mask: "XX XXXXXXX")
	]
)
...
let RegionPhoneMetadata_GB = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "1(?:[2-69][02-9]|[78])", mask: "XXXX XXXXXX"),
...
let RegionPhoneMetadata_HK = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "900", mask: "XXX XXX"),
...
let RegionPhoneMetadata_HR = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "6[01]", mask: "XX XX XXX"),
		.init(leadingDigits: "8", mask: "XXX XX XX"),
		.init(leadingDigits: "1", mask: "X XXXX XXX"),
		.init(leadingDigits: "[67]", mask: "XX XXX XXX"),
		.init(leadingDigits: "9", mask: "XX XXX XXXX"),
		.init(leadingDigits: "[2-5]", mask: "XX XXX XXXX"),
		.init(leadingDigits: "8", mask: "XXX XXX XXX")
	]
)
...
let RegionPhoneMetadata_HU = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "[2-9]", mask: "XX XXX XXX")
	]
)
...
let RegionPhoneMetadata_ID = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "2[124]|[36]1", mask: "XX XXXXXXX"),
		.init(leadingDigits: "800", mask: "XXX XXXXX"),
		.init(leadingDigits: "[2-79]", mask: "XXX XXXXXXXX"),
		.init(leadingDigits: "8[1-35-9]", mask: "XXX-XXXX-XXX"),
...
let RegionPhoneMetadata_IL = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "15", mask: "XXX-X XXX-XXXX")
	]
)
...
let RegionPhoneMetadata_IN = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "180", mask: "XXXX XXXXX"),
		...
		.init(leadingDigits: "1(?:6|8[06])", mask: "XXXX XXXX XXXX"),
...
let RegionPhoneMetadata_IR = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "(?:1[137]|2[13-68]|3[1458]|4[145]|5[1468]|6[16]|7[1467]|8[13467])[12689]", mask: "XX XXXX"),
		.init(leadingDigits: "9", mask: "XXX XXX XXX"),
...
let RegionPhoneMetadata_IT = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "1(?:0|9[246])", mask: "XXXX"),
		.init(leadingDigits: "1(?:1|92)", mask: "XXXXXX"),
		.init(leadingDigits: "0[26]", mask: "XX XXXX"),
		.init(leadingDigits: "0[13-57-9][0159]|8(?:03|4[17]|9[2-5])", mask: "XXX XXX"),
		.init(leadingDigits: "0(?:[13-579][2-46-8]|8[236-8])", mask: "XXXX XXX"),
		.init(leadingDigits: "894", mask: "XXXX XXXX"),
		.init(leadingDigits: "0[26]|5", mask: "XX XXX XXXX"),
		.init(leadingDigits: "1(?:44|[679])|[378]", mask: "XXX XXX XXXX"),
		.init(leadingDigits: "0[13-57-9][0159]|14", mask: "XXX XXXX XXXX"),
...
let RegionPhoneMetadata_JP = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "007", mask: "XXXX-XX-XXX"),
		...
		.init(leadingDigits: "0", mask: "XXXX-XXX-XXXX"),
		.init(leadingDigits: "0", mask: "XXXX-XXXX-XXXXX"),
		.init(leadingDigits: "0", mask: "XXXX-XXXXX-XXXXX"),
		.init(leadingDigits: "0", mask: "XXXX-XXXXXX-XXXXXXX")
	]
)
...
let RegionPhoneMetadata_KE = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "[24-6]", mask: "XX XXXXX"),
...
let RegionPhoneMetadata_KG = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "8", mask: "XXX XXX X XXX")
	]
)
...
let RegionPhoneMetadata_KH = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "[1-9]", mask: "XX XXX XXX"),
		.init(leadingDigits: "1", mask: "XXXX XXX XXX")
	]
)
...
let RegionPhoneMetadata_LU = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "2(?:[0367]|4[3-8])", mask: "XX XX XX X"),
		.init(leadingDigits: "80[01]|90[015]", mask: "XXX XX XXX"),
		.init(leadingDigits: "20", mask: "XX XX XX XXX"),
		.init(leadingDigits: "6", mask: "XXX XXX XXX"),
		.init(leadingDigits: "2(?:[0367]|4[3-8])", mask: "XX XX XX XX X"),
...
let RegionPhoneMetadata_MM = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "[12]", mask: "X XXX XXXX"),
...
let RegionPhoneMetadata_MN = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "[12](?:27|3[2-8]|4[2-68]|5[1-4689])", mask: "XXXX XXXXXX"),
		.init(leadingDigits: "[12]", mask: "XXXXX XXXXX")
	]
)
...
let RegionPhoneMetadata_NA = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "6", mask: "XX XXX XXX"),
...
let RegionPhoneMetadata_NG = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "[12]|9(?:0[3-9]|[1-9])", mask: "X XXX XXX"),
		.init(leadingDigits: "[3-7]|8[2-9]", mask: "XX XXX XX"),
		.init(leadingDigits: "[7-9]", mask: "XXX XXX XXX"),
		.init(leadingDigits: "[78]", mask: "XXX XXXX XXXXX"),
		.init(leadingDigits: "[78]", mask: "XXX XXXXX XXXXX")
	]
)
...
let RegionPhoneMetadata_NL = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "1", mask: "XXXXXX"),
		.init(leadingDigits: "[89]0", mask: "XXX XXXXXX"),
...
let RegionPhoneMetadata_NZ = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "8[1-79]", mask: "XX XXXXX"),
		...
		.init(leadingDigits: "1|2[028]", mask: "XX XXX XXXX"),
		.init(leadingDigits: "2(?:[169]|7[0-35-9])|7", mask: "XX XXX XXX")
	]
)
...
let RegionPhoneMetadata_OM = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "[58]", mask: "XXX XXXX"),
...
let RegionPhoneMetadata_PK = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "[89]0", mask: "XXX XXX XX"),
		...
		.init(leadingDigits: "(?:2[125]|4[0-246-9]|5[1-35-7]|6[1-8]|7[14]|8[16]|91)[2-9]", mask: "XX XXXXXXXX"),
...
let RegionPhoneMetadata_PL = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "64", mask: "XXX XX XXX"),
...
let RegionPhoneMetadata_PY = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "[2-9]0", mask: "XXX XXXXX"),
		.init(leadingDigits: "[26]1|3[289]|4[1246-8]|7[1-3]|8[1-36]", mask: "XX XXXXX"),
		.init(leadingDigits: "2[279]|3[13-5]|4[359]|5|6(?:[34]|7[1-46-8])|7[46-8]|85", mask: "XXX XXXXX"),
...
let RegionPhoneMetadata_RS = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "[1-36]", mask: "XX XXXXXXXXX")
	]
)
...
let RegionPhoneMetadata_SE = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "9(?:00|39|44)", mask: "XXX-XXX XXX"),
		.init(leadingDigits: "1[13689]|2[0136]|3[1356]|4[0246]|54|6[03]|90[1-9]", mask: "XX-XX XX XX"),
...
let RegionPhoneMetadata_SK = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "[3-5][1-8]1", mask: "XX XX XXX"),
...
let RegionPhoneMetadata_SY = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "[1-5]", mask: "XX XXX XXXX"),
		.init(leadingDigits: "9", mask: "XXX XXX XXX")
	]
)
...
let RegionPhoneMetadata_TH = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "2", mask: "X XXX XXXX"),
		.init(leadingDigits: "[13-9]", mask: "XX XXX XXXX"),
		.init(leadingDigits: "1", mask: "XXXX XXX XXX")
	]
)
...
let RegionPhoneMetadata_TW = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "[258]0", mask: "XX XXX XXXX"),
		.init(leadingDigits: "[23568]|4(?:0[02-48]|[1-47-9])|7[1-9]", mask: "X XXX XXXX"),
		.init(leadingDigits: "[49]", mask: "XXX XXX XXX"),
...
let RegionPhoneMetadata_UY = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "0", mask: "XXX XXX XXXX"),
		.init(leadingDigits: "0", mask: "XXX XXX XXX XXX")
	]
)
...
let RegionPhoneMetadata_VN = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "69", mask: "XXX XXXX"),
		.init(leadingDigits: "1", mask: "XXXX XXXXX"),
...
let RegionPhoneMetadata_WS = RegionPhoneMetadata(
    ...
    ranges: [
		...
		.init(leadingDigits: "[68]", mask: "XXX XXXXXXX"),
		.init(leadingDigits: "7", mask: "XX XXXXX")
	]
)
...
let RegionPhoneMetadata_ZA = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "8[1-4]", mask: "XX XXX"),
		.init(leadingDigits: "8[1-4]", mask: "XX XXX XX"),
...
let RegionPhoneMetadata_ZW = RegionPhoneMetadata(
    ...
    ranges: [
		.init(leadingDigits: "2(?:0[45]|2[278]|[49]8)|3(?:[09]8|17)|6(?:[29]8|37|75)|[23][78]|(?:33|5[15]|6[68])[78]", mask: "XXX XXXX"),
		...
		.init(leadingDigits: "7", mask: "XX XXX XXXX"),
		.init(leadingDigits: "2(?:1[39]|2[0157]|[378]|[56][14])|3(?:12|29)", mask: "XXX XXX XXX"),
		.init(leadingDigits: "8", mask: "XXXX XXXXXX"),
		.init(leadingDigits: "1|2(?:0[0-36-9]|12|29|[56])|3(?:1[0-689]|[24-6])|5(?:[0236-9]|1[2-4])|6(?:[013-59]|7[0-46-9])|(?:33|55|6[68])[0-69]|(?:29|3[09]|62)[0-79]", mask: "XX XXX"),
